...
selected_file ="/storage/emulated/0/DJdev/example.pcm"
...
def check_hello():
    print("Hello Check Hello Print")
    lines = [line.strip() for line in open(selected_file)]
    print(lines)


def audio_samples(in_data):

    #in_data = bytes(in_data, "UTF-16")

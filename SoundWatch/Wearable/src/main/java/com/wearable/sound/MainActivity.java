...
//            soundLastTime.put(audio_label, test);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (dataPassed != null)
        {
            ...
            locationDisplay.setText(audioLabel);
    ...
    protected void onNewIntent(Intent intent) {
        ...
        String[] dataPassed = {"", "", ""};
        dataPassed = intent.getStringArrayExtra("audio_label");
        if (dataPassed != null)
        {
            audioLabel = dataPassed[0];
            confidence = dataPassed[1];
            ...
            TextView locationDisplay = findViewById(R.id.locationDisplay);
            locationDisplay.setText(audioLabel);
            soundDisplay.setText(audioTime + ", " + (int) Math.round(Double.parseDouble(confidence )*100) + "%");
